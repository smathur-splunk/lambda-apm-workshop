...
4. On the 'Create stack' page, select `Upload a template file`, and then `Choose file` to select the CloudFormation template you downloaded in Step 1. Go ahead and click `Next`. <img src="images/step04.png" height="600"/>
...
11. On the 'Install Integration' page, select `Python`. Follow the steps on this page to add the Splunk OTel layer and set the environment variables. For the ARN, use `arn:aws:lambda:us-east-1:254067382080:layer:splunk-apm:51`. <img src="images/step11-1.png" height="650"/> <img src="images/step11-2.png" height="350"/> <img src="images/step11-3.png"/> <img src="images/step11-4.png" height="350"/> <img src="images/step11-5.png"/> <img src="images/step11-6.png" height="600"/>
